        ...
        <div className="relative h-full w-full rounded-lg bg-white p-4 shadow-2xl shadow-white">
            <div className="relative">
                <img
                    ...
                    width={80}
                    height={80}
                    className="opacity-1 absolute -left-7 -top-10 z-0 rotate-3"
            ...
            <Collapse defaultActiveKey={['1', '2', '3']} ghost>
                ...
                <Panel header={<p className="font-bold">Sản Phẩm</p>} key="2">
                ...
                <Panel header={<p className="font-bold">Tỉnh thành</p>} key="3">
