...
const BackDriversLicense = ({ setStep }: StepProps) => {
    ...
    return (
        <SectionCommon className="flex flex-col gap-4">
            ...
            >
                {image ? (
                    ...
                    <video
                        ref={videoRef}
                        autoPlay
                        className="h-[300px] w-[700px] rounded-xl object-cover"
                    />
                ) : (
            ...
            <div className="flex w-full flex-col items-center justify-center gap-2">
                <h2 className="flex w-full items-center justify-center text-xl font-bold text-primary">
                    Mặt sau
                </h2>
...
export default BackDriversLicense
